...
cat("\n")
cat("Clinical significance is determined from the probability curve for SPRE predictions,if any 2 predictions from the second significant digit (after the decimal place) remains constant. Otherwise, there is clinical significance at the vertical line (zero) at the change point.")
...
#' @return plot comparisons
        ...
        m4 <-signif(m4,digits=4)
        title(paste(main = "SPRE Weibull prediction comparison, Prob=",m4[2],           "\n","\n","\n"))
